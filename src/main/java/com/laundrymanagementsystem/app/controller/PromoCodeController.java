...
public class PromoCodeController {
	...
	@PutMapping(value = "/promoCode/update", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@DeleteMapping(value = "/promoCode/{id}/delete", produces = MediaType.APPLICATION_JSON_VALUE)
	public ApiResponseDto deletePromoCodeById(@PathVariable(required = true) long id) {
		ApiResponseDtoBuilder apiResponseDtoBuilder = new ApiResponseDtoBuilder();
		promoCodeService.deletePromoCodeById(id, apiResponseDtoBuilder);
		return apiResponseDtoBuilder.build();
	}
}
