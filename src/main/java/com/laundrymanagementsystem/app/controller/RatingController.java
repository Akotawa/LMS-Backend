...
public class RatingController {
	...
	@PostMapping(value = "/laundry/rating/add", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@GetMapping(value = "/laundry/{laundryid}/ratings", produces = MediaType.APPLICATION_JSON_VALUE)
