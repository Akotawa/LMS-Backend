...
public class LaundryController {
	...
	@PostMapping(value = "/laundry/update", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
	...
	@PostMapping(value = "/laundry/{id}/{active}", produces = MediaType.APPLICATION_JSON_VALUE)
